...
Comprehensive unit tests for data models including Artist, Album, Track, Playlist,
and SearchResults. Tests cover initialization, serialization, validation, and edge cases.
"""
...
class TestSearchResults:
    ...
    def test_search_results_total_results(self):
        ...
        results = SearchResults(
            ...
            artists=[],  # Empty
            playlists=[Playlist(id="4", title="P1"), Playlist(id="5", title="P2"), Playlist(id="6", title="P3")]
        )
