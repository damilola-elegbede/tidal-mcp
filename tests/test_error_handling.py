...
Tests for error scenarios, edge cases, and failure modes across all
components of the Tidal MCP server. Ensures robust error handling and
...
class TestAuthenticationErrors:
    ...
    async def test_auth_network_failure(self, temp_session_file):
        ...
        with patch.object(
            TidalAuth, "_oauth2_flow", new_callable=AsyncMock
        ) as mock_oauth:
